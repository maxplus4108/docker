"""
Django settings for maxdoc project.
...
SECRET_KEY = 'django-insecure-x#d=w(wbp_cqbcc+@a5^^dy(l4e7k=pt#(((o$$f+&l1loi$_+'
...
WSGI_APPLICATION = 'maxdoc.wsgi.application'
